...
window.OkiModel = Backbone.Model.extend({
    defaults: {
        ID: "",
        STIP: "",
        MPO: "",
...
window.OkiCollection = Backbone.Collection.extend({
  model: OkiModel,
  comparator: function(okimodel) {
    return okimodel.get("PID");
