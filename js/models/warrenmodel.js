...
window.WarrenModel = Backbone.Model.extend({
    defaults: {
        PID: "",
        County: "",
        Sponsor: "",
...
dojo.addOnLoad(init);
this.warrencollection = new WarrenCollection();
this.warrenmodel = new WarrenModel();
// console.log(hc);
