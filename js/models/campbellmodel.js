...
window.CampbellModel = Backbone.Model.extend({
    defaults: {
        PID: "",
        County: "",
        Sponsor: "",
...
dojo.addOnLoad(init);
this.campbellcollection = new CampbellCollection();
this.campbellmodel = new CampbellModel();
// console.log(hc);
